...
class Ui_CantinaGUI(object):
    def setupUi(self, CantinaGUI):
        ...
        '''CantinaGUI.resize(637, 769)                          #scommentare per modificare grandezza window cantina
        ...
        name.append(self.vv16.objectName())
        self.vv16.clicked.connect(lambda: self.functemp(name[31]))
        ...
        name.append(self.locale3.objectName())
        self.locale3.clicked.connect(lambda: self.functemp(name[15]))
        ...
        name.append(self.locale1.objectName())
        self.locale1.clicked.connect(lambda: self.functemp(name[30]))
        self.gridLayout.addWidget(self.locale1, 0, 0, 1, 1)
        self.vv9 = QtWidgets.QPushButton(self.list_grid)
        self.vv9.setObjectName("vv9")
        name.append(self.vv9.objectName())
        self.vv9.clicked.connect(lambda: self.functemp(name[31]))
        ...
        dataora=Thread(target=self.ora, args=[self], daemon=True)
        dataora.start()
